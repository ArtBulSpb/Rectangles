...
print("\033[0m\033[41m\033[1m\033[30m{}".format("а) Принадлежат ли все точки первого прямоугольника второму:"))
...
print("\033[0m\033[40m\033[33m\033[6m{}".format("в) Пересекаются ли эти прямоугольники:"))
