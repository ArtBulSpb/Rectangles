...
print("\033[0m\033[30m\033[46m{}".format("Введите координаты для"))
...
print("\n\033[0m\033[40m\033[3m\033[34m{}".format("Прямоугольника 2:"))
rect2 = Rectangle(int(input("x левого нижнего угла = ")), int(input("y левого нижнего угла = ")),
                  int(input("ширина = ")), int(input("высота = ")))

print("\033[0m\033[41m\033[1m\033[35m{}".format("а) Принадлежат ли все точки первого прямоугольника второму:"))
print(rect2.is_involved(rect1))
print("\033[0m\033[47m\033[30m\033[4m{}".format("б) Принадлежат ли все точки одного из прямоугольников другому:"))
print(rect2.is_involved(rect1) or rect1.is_involved(rect2))
print("\033[0m\033[40m\033[33m\033[6m\033[4m{}".format("в) Пересекаются ли эти прямоугольники:"))
